...
class PredictApiView(APIView):
    ...
    def post(self, request, format = None):
        predict = [[request.data["predict"]["pregnancies"], request.data["predict"]["glucose"],
                    request.data["predict"]["bloodpressure"], request.data["predict"]["bmi"],
                    request.data["predict"]["diabetespedigreefunction"], request.data["predict"]["age"]]]
